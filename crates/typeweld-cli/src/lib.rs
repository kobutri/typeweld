...
use typeweld_core::{ApiModule, IntoApiRoot};
use typeweld_ir::{
...
struct EndpointAccessor {
    ...
    namespace: String,
    transport: typeweld_ir::Transport,
    request: typeweld_ir::RequestShape,
    response: ResponseShape,
    errors: Vec<typeweld_ir::ErrorRef>,
}
...
struct SemanticScannerEndpoint<'a> {
    ...
    transport: typeweld_ir::Transport,
    request: &'a typeweld_ir::RequestShape,
    response: &'a ResponseShape,
    errors: &'a [typeweld_ir::ErrorRef],
}
...
fn error_tag_symbol_id(variant: &typeweld_ir::ErrorVariant) -> SymbolId {
