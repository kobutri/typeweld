...
pub trait ApiError: ApiType {
    ...
    fn status(&self) -> typeweld_ir::HttpStatus;
...
impl Endpoint {
    ...
    #[must_use]
    pub fn into_ir(self) -> typeweld_ir::Endpoint {
        typeweld_ir::Endpoint {
            id: self.id,
            rust_path: self.rust_path,
...
impl ApiModule {
    ...
    #[doc(hidden)]
    #[must_use]
    pub fn endpoint_irs(&self) -> Vec<typeweld_ir::Endpoint> {
        self.endpoints
            .iter()
            .cloned()
