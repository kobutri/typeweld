...
use serde_json::json;
use typeweld_core::{ApiError, ApiType};

#[derive(typeweld_macros::ApiType, Clone, Debug, Deserialize, PartialEq, Serialize)]
#[allow(dead_code)]
struct ValidationIssue {
    code: String,
}

#[derive(typeweld_macros::ApiError, Clone, Debug, Deserialize, PartialEq, Serialize)]
