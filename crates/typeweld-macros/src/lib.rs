...
impl visit_mut::VisitMut for ApiRouterEndpointRewriter {
    fn visit_expr_method_call_mut(&mut self, call: &mut ExprMethodCall) {
        ...
        let adapter_path = generated_router_helper_path(path, "__typeweld_axum_handler_");
...
fn expand_api_type(input: DeriveInput) -> syn::Result<proc_macro2::TokenStream> {
        ...
        Data::Struct(data) => match data.fields {
            Fields::Named(fields) => {
                ...
                if container_serde.transparent {
                    ...
                    quote! {
                        ::typeweld_core::ir::TypeShape::Newtype(Box::new(
                            <#field_ty as ::typeweld_core::ApiType>::type_ref()
                        ))
                    }
                } else {
                    ...
                    quote! {
                        ::typeweld_core::ir::TypeShape::Struct(::typeweld_core::ir::StructShape {
        ...
        Data::Enum(data) => {
            ...
            let variants = data
                ...
                .map(|variant| {
                    ...
                    Ok(quote! {
                        ::typeweld_core::ir::EnumVariant {
                            id: {
                                let owner = <Self as ::typeweld_core::ApiType>::rust_path().join("::");
                                ::typeweld_core::ir::SymbolId::from_parts(
                                    "enum_variant",
                                    &[&owner, #variant_name],
                                )
                            },
                            ...
                            source: ::typeweld_core::ir::SourceRange {
                                file: file!().to_owned(),
                                start_line: line!(),
                                start_column: column!(),
                                end_line: line!(),
            ...
            quote! {
                ::typeweld_core::ir::TypeShape::Enum(::typeweld_core::ir::EnumShape {
    ...
    Ok(quote! {
        impl ::typeweld_core::ApiType for #ident {
            ...
            fn rust_path() -> Vec<String> {
                let mut path = module_path!()
                    ...
                    .map(str::to_owned)
                    .collect::<Vec<_>>();
                path.push(<Self as ::typeweld_core::ApiType>::RUST_NAME.to_owned());
                path
            }

            fn type_ref() -> ::typeweld_core::ir::TypeRef {
                let rust_path = <Self as ::typeweld_core::ApiType>::rust_path();
                let parts = rust_path.iter().map(String::as_str).collect::<Vec<_>>();

                ::typeweld_core::ir::TypeRef {
                    id: ::typeweld_core::ir::SymbolId::from_parts("type", &parts),
                    name: <Self as ::typeweld_core::ApiType>::TS_NAME.to_owned(),
                }
            }

            fn type_def() -> ::typeweld_core::ir::TypeDef {
                ::typeweld_core::ir::TypeDef {
                    id: <Self as ::typeweld_core::ApiType>::type_ref().id,
                    rust_path: <Self as ::typeweld_core::ApiType>::rust_path(),
                    rust_name: <Self as ::typeweld_core::ApiType>::RUST_NAME.to_owned(),
                    ts_name: <Self as ::typeweld_core::ApiType>::TS_NAME.to_owned(),
                    shape: #shape,
                    source: ::typeweld_core::ir::SourceRange {
                        file: file!().to_owned(),
                        start_line: line!(),
            ...
            fn register_types(registry: &mut ::typeweld_core::TypeRegistry) {
                if registry.insert(<Self as ::typeweld_core::ApiType>::type_def()) {
                    #(#register_types)*
                }
            }
        }
...
fn expand_api_error(input: DeriveInput) -> syn::Result<proc_macro2::TokenStream> {
    ...
    for variant in &data.variants {
        ...
        api_type_variants.push(quote! {
            ::typeweld_core::ir::EnumVariant {
                id: {
                    let owner = <Self as ::typeweld_core::ApiType>::rust_path().join("::");
                    ::typeweld_core::ir::SymbolId::from_parts("enum_variant", &[&owner, #variant_name])
                },
                rust_name: #variant_name.to_owned(),
        ...
        error_variants.push(quote! {
            ::typeweld_core::ir::ErrorVariant {
                id: {
                    let owner = <Self as ::typeweld_core::ApiType>::rust_path().join("::");
                    ::typeweld_core::ir::SymbolId::from_parts("error_variant", &[&owner, #variant_name])
                },
                rust_name: #variant_name.to_owned(),
                tag: #tag.to_owned(),
                status: ::typeweld_core::ir::HttpStatus(#status),
                fields: vec![#(#fields),*],
                source: ::typeweld_core::ir::SourceRange {
                    file: file!().to_owned(),
                    start_line: line!(),
        ...
        status_arms.push(quote!(#pattern => ::typeweld_core::ir::HttpStatus(#status)));
    }
    ...
    Ok(quote! {
        impl ::typeweld_core::ApiType for #ident {
            ...
            fn type_def() -> ::typeweld_core::ir::TypeDef {
                ::typeweld_core::ir::TypeDef {
                    ...
                    rust_name: <Self as ::typeweld_core::ApiType>::RUST_NAME.to_owned(),
                    ts_name: <Self as ::typeweld_core::ApiType>::TS_NAME.to_owned(),
                    shape: ::typeweld_core::ir::TypeShape::Enum(::typeweld_core::ir::EnumShape {
        ...
        impl ::typeweld_core::ApiError for #ident {
            fn status(&self) -> ::typeweld_core::ir::HttpStatus {
                match self {
                    #(#status_arms,)*
                }
            }

            fn error_def() -> ::typeweld_core::ir::ErrorDef {
                ::typeweld_core::ir::ErrorDef {
                    id: <Self as ::typeweld_core::ApiError>::error_ref().id,
                    rust_path: <Self as ::typeweld_core::ApiType>::rust_path(),
                    rust_name: <Self as ::typeweld_core::ApiType>::RUST_NAME.to_owned(),
                    ts_name: <Self as ::typeweld_core::ApiType>::TS_NAME.to_owned(),
            ...
            fn register_error(registry: &mut ::typeweld_core::ContractRegistry) {
                if registry.insert_error(<Self as ::typeweld_core::ApiError>::error_def()) {
...
fn expand_api_endpoint(args: ApiAttr, input: ItemFn) -> syn::Result<proc_macro2::TokenStream> {
    ...
    let axum_handler_ident = format_ident!("__typeweld_axum_handler_{fn_ident}");
    ...
    Ok(quote! {
        ...
        pub fn #descriptor_ident() -> ::typeweld_core::EndpointDescriptor {
            ...
            let endpoint = ::typeweld_core::Endpoint::new(#method, #path)
                .named(rust_path)
            ...
            ::typeweld_core::EndpointDescriptor::new(endpoint, #register_ident)
        }

        #[doc(hidden)]
        #[allow(non_snake_case, unused_variables)]
        pub fn #register_ident(registry: &mut ::typeweld_core::ContractRegistry) {
...
fn endpoint_request(
    ...
    let mut body = None;
    let mut body_transport = quote!(::typeweld_core::ir::RequestBodyTransport::Json);
    ...
    for input in inputs {
        ...
        if let Some(inner) = extractor_inner(input.ty.as_ref(), "Path") {
            ...
            body = Some(quote!(Some(<#inner as ::typeweld_core::ApiType>::type_ref())));
            registrations.push(contract_register_type_call(inner));
        } else if let Some(inner) = extractor_inner(input.ty.as_ref(), "Binary") {
            ensure_no_endpoint_body(body.is_some(), input)?;
            validate_binary_bytes_type(inner)?;
            body = Some(quote!(Some(<#inner as ::typeweld_core::ApiType>::type_ref())));
            body_transport = quote!(::typeweld_core::ir::RequestBodyTransport::Binary);
            is_binary_body = true;
        } else {
            return Err(syn::Error::new_spanned(
                input.ty.as_ref(),
...
fn register_type_call(ty: &Type) -> proc_macro2::TokenStream {
    quote! {
        <#ty as ::typeweld_core::ApiType>::register_types(registry);
    }
}
...
fn endpoint_field(name: &str, ty: &Type) -> proc_macro2::TokenStream {
    quote! {
        ::typeweld_core::ir::Field {
            id: {
                let owner = module_path!();
                ::typeweld_core::ir::SymbolId::from_parts("endpoint_field", &[owner, #name])
            },
            rust_name: #name.to_owned(),
            wire_name: #name.to_owned(),
            ts_name: #name.to_owned(),
            type_ref: <#ty as ::typeweld_core::ApiType>::type_ref(),
            optionality: ::typeweld_core::ir::Optionality::Required,
            source: ::typeweld_core::ir::SourceRange {
                file: file!().to_owned(),
                start_line: line!(),
                start_column: column!(),
...
fn endpoint_return(output: &ReturnType) -> syn::Result<EndpointReturn> {
    match output {
        ReturnType::Default => Ok(EndpointReturn {
            response: quote!(::typeweld_core::ir::ResponseShape::Empty),
            errors: Vec::new(),
...
fn return_for_type(ty: &Type) -> syn::Result<EndpointReturn> {
    ...
    if let Some(inner) = extractor_inner(ty, "Binary") {
        ...
        return Ok(EndpointReturn {
            response: quote! {
                ::typeweld_core::ir::ResponseShape::Binary { content_type: None }
            },
            errors: Vec::new(),
            registrations: Vec::new(),
            is_stream: false,
    ...
    if let Some(inner) = extractor_inner(ty, "Json") {
        return Ok(EndpointReturn {
            response: quote! {
                ::typeweld_core::ir::ResponseShape::Json(<#inner as ::typeweld_core::ApiType>::type_ref())
            },
            errors: Vec::new(),
    ...
    if let Some(inner) = extractor_inner(ty, "Created") {
        return Ok(EndpointReturn {
            response: quote! {
                ::typeweld_core::ir::ResponseShape::Created(<#inner as ::typeweld_core::ApiType>::type_ref())
            },
            errors: Vec::new(),
            registrations: vec![contract_register_type_call(inner)],
            is_stream: false,
    ...
    if let Some(inner) = extractor_inner(ty, "Sse") {
        return Ok(EndpointReturn {
            response: quote! {
                ::typeweld_core::ir::ResponseShape::Stream(<#inner as ::typeweld_core::ApiType>::type_ref())
            },
            errors: Vec::new(),
            registrations: vec![contract_register_type_call(inner)],
            is_stream: true,
    ...
    if let Some((ok, err)) = result_types(ty) {
        ...
        return Ok(EndpointReturn {
            ...
            errors: vec![quote!(<#err as ::typeweld_core::ApiError>::error_ref())],
            registrations,
...
impl EndpointReturn {
    fn adapter_response(
        ...
        if self.is_result {
            quote!(::typeweld_axum::success_or_error_response(#endpoint_call))
        } else {
            quote!(::typeweld_axum::into_api_response(#endpoint_call))
        }
    }
}
...
impl ApiAttr {
    ...
    fn method_tokens(&self) -> syn::Result<proc_macro2::TokenStream> {
        match self.method.as_str() {
            "DELETE" => Ok(quote!(::typeweld_core::ir::HttpMethod::Delete)),
            "GET" => Ok(quote!(::typeweld_core::ir::HttpMethod::Get)),
            "PATCH" => Ok(quote!(::typeweld_core::ir::HttpMethod::Patch)),
            "POST" => Ok(quote!(::typeweld_core::ir::HttpMethod::Post)),
            "PUT" => Ok(quote!(::typeweld_core::ir::HttpMethod::Put)),
            "SSE" => Ok(quote!(::typeweld_core::ir::HttpMethod::Get)),
            _ => Err(syn::Error::new(
                proc_macro2::Span::call_site(),
    ...
    fn transport_tokens(
        ...
        if self.is_sse() {
            quote!(::typeweld_core::ir::Transport::ServerSentEvents)
        } else if endpoint_return.is_binary {
            quote!(::typeweld_core::ir::Transport::BinaryDownload)
        } else if request.is_binary_body {
            quote!(::typeweld_core::ir::Transport::BinaryUpload)
        } else {
            quote!(::typeweld_core::ir::Transport::UnaryHttp)
        }
    }
...
fn field_def(
    ...
    quote! {
        ::typeweld_core::ir::Field {
            id: {
                let owner = <Self as ::typeweld_core::ApiType>::rust_path().join("::");
                ::typeweld_core::ir::SymbolId::from_parts("field", &[&owner, #owner_name, #field_name])
            },
            rust_name: #field_name.to_owned(),
            wire_name: #wire_name.to_owned(),
            ts_name: #wire_name.to_owned(),
            type_ref: <#field_ty as ::typeweld_core::ApiType>::type_ref(),
...
impl WireOptionality {
    fn tokens(self) -> proc_macro2::TokenStream {
        match self {
            Self::Required => quote!(::typeweld_core::ir::Optionality::Required),
            Self::Optional => quote!(::typeweld_core::ir::Optionality::Optional),
            Self::Nullable => quote!(::typeweld_core::ir::Optionality::Nullable),
            Self::OptionalNullable => quote!(::typeweld_core::ir::Optionality::OptionalNullable),
        }
    }
}
