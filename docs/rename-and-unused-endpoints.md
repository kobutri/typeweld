...
rename starts on a linked Rust or TypeScript location, `typeweld-ls` builds a single
...
Build scripts can use `typeweld-build` to turn this into Cargo warnings or
